...
namespace CoursesWebAPI.Persistence.Repositories
{
    public sealed class StudentRepository : RepositoryBase<Student>, IStudentRepository
    {
        ...
        {
            return await FindByCondition(s => s.Id.Equals(id), trackChanges).FirstOrDefaultAsync(cancellationToken);
        }

        public Task<PageList<Student>> GetByParametersAsync(EmployeeQueryParameters parameters, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<PageList<Student>> GetStudentsAsync(EmployeeQueryParameters parameters, CancellationToken cancellationToken = default)
        {
        ...
        private IQueryable<Student> GetQueryByParameters(EmployeeQueryParameters parameters, bool trackChanges) =>
