...
namespace CoursesWebAPI.Persistence.Migrations
{
    ...
    [Migration("20231212082447_AddPermissionsAndUpdateRefreshToken")]
    partial class AddPermissionsAndUpdateRefreshToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivityContract", b =>
                {
                    ...
                    b.HasKey("ActivitiesId", "ContractsId");
            ...
            modelBuilder.Entity("CoursesWebAPI.Core.Identity.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CoursesWebAPI.Core.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b9c0f777-a254-429f-bb3f-6d2630b7b3e2",
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("CoursesWebAPI.Core.Identity.Permission", null)
                        .WithMany()
