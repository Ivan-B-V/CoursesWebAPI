    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Persosns", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_Persosns_Id",
                        column: x => x.Id,
                        principalTable: "Persosns",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<string>(type: "character(84)", fixedLength: true, maxLength: 84, nullable: true),
                    SecurityStamp = table.Column<string>(type: "character varying(36)", maxLength: 36, nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character(36)", fixedLength: true, maxLength: 36, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Persosns_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persosns",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Activities_Employees_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cost = table.Column<decimal>(type: "numeric(7,2)", precision: 7, scale: 2, nullable: false, defaultValue: 0m),
                    Hours = table.Column<short>(type: "smallint", nullable: false),
                    PaidHours = table.Column<short>(type: "smallint", nullable: false),
                    PassedHours = table.Column<short>(type: "smallint", nullable: false),
                    Closed = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    Concluded = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderDisplayName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityContract", x => new { x.ClassesId, x.ContractsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivityContract_Contracts_ContractsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityContract_ContractsId",
